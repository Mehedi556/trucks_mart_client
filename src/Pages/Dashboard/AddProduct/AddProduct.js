          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <div className="card-body">
              ...
              <div className="form-control">
                ...
                <input
                  {...register('image', { required: 'Truck name is required' })}
                  type="file"
                  className="input input-bordered"
                  required
                />
              ...
              <div className="form-control">
                ...
                <input
                  {...register('name', { required: 'Truck name is required' })}
                  type="text"
              ...
              <div className="form-control">
                ...
                <textarea
                  ...
                  type="text-area"
                  placeholder="Description about this truck..."
